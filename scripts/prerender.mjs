...
const TITLES = {
  ...
  'irs-4812': 'IRS Publication 4812 Changes — 2013, Rev. 8-2020, 9-2023, 12-2024, 12-2025',
...
const DESCRIPTIONS = {
  ...
  'irs-4812': (s) => `IRS Publication 4812 contractor security control changes from the original 2013 publication through the August 2020, September 2023, December 2024, and December 2025 revisions — the only interactive changelog for IRS contractor compliance. ${s.total} tracked changes.`,
